...
type 'a varInfo = { name : string; varType : 'a coraltype option } [@@deriving sexp_of, compare]
...
type node_data =
  ...
  | Func of { name : string; ret_type : node coraltype option; params : node list; body : node }
